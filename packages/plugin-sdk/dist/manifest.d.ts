...
export declare const pluginManifestSchema: {
    ...
    readonly $id: "https://schemas.cinyuverse.dev/plugin/v4/plugin.schema.json";
    ...
    readonly properties: {
        ...
        readonly engines: {
            readonly type: "object";
            readonly additionalProperties: false;
            readonly required: readonly ["cinyuverse", "pluginSdk"];
            readonly properties: {
                readonly cinyuverse: {
                    readonly type: "string";
                    readonly minLength: 1;
        ...
        readonly content: {
            ...
            readonly properties: {
                ...
                readonly index: {
                    readonly const: ".cinyuverse-plugin/content.index.json";
                };
            };
        };
        readonly config: {
