...
import { CINYUVERSE_PLUGIN_API_VERSION, CINYUVERSE_PLUGIN_PROTOCOL_VERSION } from './protocol.js';
            ...
            switch (message.method) {
                case 'initialize': {
                    ...
                    send({
                        ...
                        ok: true,
                        result: {
                            protocolVersion: CINYUVERSE_PLUGIN_PROTOCOL_VERSION,
                            sdkVersion: CINYUVERSE_PLUGIN_API_VERSION,
                            registrations: [],
                            requestedFeatures: [],
                        },
                    });
