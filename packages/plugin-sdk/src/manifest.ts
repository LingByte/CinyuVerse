/** Public authoring contract for a Cinyuverse product plugin. */
export interface CinyuversePluginManifest {
  $schema?: string;
  manifestVersion: 4;
  apiVersion: "1.0";
  id: string;
...
/** Package-relative MCP process supervised and credentialed by the Cinyuverse Host. */
...
export const pluginManifestSchema = {
  ...
  $id: "https://schemas.cinyuverse.dev/plugin/v4/plugin.schema.json",
  type: "object",
  ...
  properties: {
    ...
    engines: {
      type: "object",
      additionalProperties: false,
      required: ["cinyuverse", "pluginSdk"],
      properties: {
        cinyuverse: { type: "string", minLength: 1 },
    ...
    content: {
      ...
      properties: {
        root: { const: "contents" },
        index: { const: ".cinyuverse-plugin/content.index.json" },
      },
    },
    config: {
      type: "object",
