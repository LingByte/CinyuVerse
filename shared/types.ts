...
export type Config = { config_version: string, theme: ThemeMode, executor_profile: ExecutorProfileId, disclaimer_acknowledged: boolean, onboarding_acknowledged: boolean, notifications: NotificationConfig, editor: EditorConfig, github: GitHubConfig, workspace_dir: string | null, last_app_version: string | null, show_release_notes: boolean, language: UiLanguage, git_branch_prefix: string, pr_auto_description_enabled: boolean, pr_auto_description_prompt: string | null, pr_auto_description_agent_id: string, pr_auto_description_mode: string | null, pr_auto_description_session_config: { [key in string]?: string }, commit_reminder_enabled: boolean, commit_reminder_mode: CommitReminderMode, commit_reminder_line_threshold: number, send_message_shortcut: SendMessageShortcut, prompt_enhancement_enabled: boolean, prompt_enhancement_model: string, prompt_enhancement_agent_id: string, prompt_enhancement_mode: string | null, prompt_enhancement_session_config: { [key in string]?: string }, prompt_enhancement_prompt: string | null, default_terminal_shell: string | null, files_changed_default_collapsed: boolean, ai_message_default_collapsed: boolean,
/**
