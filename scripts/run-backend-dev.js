 ...
 * Replaces: DISABLE_WORKTREE_CLEANUP=1 RUST_LOG=debug cargo watch -w crates -x 'run --bin cinyuverse-server'
 */
...
const child = spawn("cargo", ["watch", "-w", "crates", "-x", "run --bin cinyuverse-server"], {
  env,
  stdio: "inherit",
});
