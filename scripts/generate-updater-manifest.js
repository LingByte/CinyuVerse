...
const updaterTargets = [
  {
    artifactName: "Cinyuverse-windows-x64",
    platform: "windows-x86_64",
    assetName(version) {
      return `Cinyuverse-${version}-windows-x86_64-setup.exe`;
    },
    matches(filePath) {
      return (
  ...
  {
    artifactName: "Cinyuverse-windows-arm64",
    platform: "windows-aarch64",
    assetName(version) {
      return `Cinyuverse-${version}-windows-aarch64-setup.exe`;
    },
    matches(filePath) {
      return (
        filePath.includes(`${path.sep}nsis${path.sep}`) &&
  ...
  {
    artifactName: "Cinyuverse-linux-x64",
    platform: "linux-x86_64",
    assetName(version) {
      return `Cinyuverse-${version}-linux-x86_64.AppImage`;
    },
    matches(filePath) {
  ...
  {
    artifactName: "Cinyuverse-linux-arm64",
    platform: "linux-aarch64",
    assetName(version) {
      return `Cinyuverse-${version}-linux-aarch64.AppImage`;
    },
    matches(filePath) {
      return filePath.endsWith(".AppImage");
    },
  ...
  {
    artifactName: "Cinyuverse-macos-arm64",
    platform: "darwin-aarch64",
    assetName(version) {
      return `Cinyuverse-${version}-darwin-aarch64.app.tar.gz`;
    },
    matches(filePath) {
...
const installerTargets = [
  {
    artifactName: "Cinyuverse-macos-arm64",
    assetName(version) {
      return `Cinyuverse-${version}-darwin-aarch64.dmg`;
    },
    matches(filePath) {
