...
import { Files, BookOpen, List } from 'lucide-vue-next'
...
<template>
  <div class="left-sidebar">
    <div class="sidebar-tabs">
      <button class="tab-btn" :class="{ active: tab === 'tree' }" @click="tab = 'tree'">
        <Files :size="12" /> 目录
      </button>
      <button class="tab-btn" :class="{ active: tab === 'meta' }" @click="tab = 'meta'">
        <BookOpen :size="12" /> 设定
      </button>
      <button class="tab-btn" :class="{ active: tab === 'outline' }" @click="tab = 'outline'">
        <List :size="12" /> 大纲
      </button>
    </div>
