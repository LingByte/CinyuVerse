...
async fn refuses_to_lease_an_installation_outside_its_version_directory() {
    ...
    let lock = ToolInstallationLock {
        ...
        source_url: "https://downloads.cinyuverse.dev/fixtures/officecli".into(),
        sha256: "a".repeat(64),
...
async fn persists_versioned_installation_lock() {
    ...
    let request = ToolRequest {
        ...
        url: "https://downloads.cinyuverse.dev/fixtures/officecli".to_string(),
    ...
    assert_eq!(
        current.source_url,
        "https://downloads.cinyuverse.dev/fixtures/officecli"
    );
