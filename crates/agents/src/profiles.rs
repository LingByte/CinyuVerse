...
const KIMI_FIELDS: &[NativeConfigField] = &[
    ...
    json_field(
        ...
        &["models", "cinyuverse", "capabilities"],
    ),
    json_field(
        "kimi_support_efforts",
        "可选推理强度",
        "Kimi ACP 暴露给会话的 support_efforts 数组",
        &["models", "cinyuverse", "support_efforts"],
    ),
    text_field(
        "kimi_default_effort",
        "默认推理强度",
...
const GROK_FIELDS: &[NativeConfigField] = &[
    ...
    authentication(text_field(
        ...
        "API URL",
        "自定义模型端点",
        &["model", "cinyuverse", "base_url"],
    )),
    authentication(secret_field(
        "grok_api_key",
        "xAI API Key",
        "自定义模型凭据",
        &["model", "cinyuverse", "api_key"],
    )),
    authentication(select_field(
        "grok_api_backend",
        "API 协议",
        "自定义模型使用的请求协议",
        &["model", "cinyuverse", "api_backend"],
        &[
    ...
    authentication(number_field(
        ...
        &["model", "cinyuverse", "context_window"],
    )),
    with_default(
        number_field(
