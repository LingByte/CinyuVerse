...
mod tests {
    ...
    fn macos_private_prefix_and_separators_match() {
        assert!(history_paths_overlap(
            "/private/Users/mac/Projects/Cinyuverse",
    ...
    fn longest_overlapping_destination_wins() {
        ...
        let destinations = vec![
            HistoryPathDestination {
                path: "/Users/mac/Projects/Cinyuverse".into(),
                project_id: project,
                project_name: "Cinyuverse".into(),
                workspace_id: workspace,
            },
            HistoryPathDestination {
                path: "/Users/mac/Projects/Cinyuverse/crates/agents".into(),
                project_id: project,
                project_name: "Cinyuverse".into(),
                workspace_id: nested,
            },
        ...
        let matched = match_history_destination(
            Some("/Users/mac/Projects/Cinyuverse/crates/agents/src"),
            &destinations,
        )
        .expect("nested match");
        ...
        let page = build_local_history_scan_page(
            vec![
                session(
                    AgentKind::Codex,
                    "already",
                    Some("/Users/mac/Projects/Cinyuverse"),
                    "Old Codex",
                ),
                session(
                    AgentKind::ClaudeCode,
                    "fresh",
                    Some("/private/Users/mac/Projects/Cinyuverse"),
                    "New Claude",
                ),
