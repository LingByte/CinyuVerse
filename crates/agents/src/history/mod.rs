...
/// Resolve history locations from both the current process and Cinyuverse's saved
...
mod tests {
    ...
    fn grok_summary_json_supplies_cwd_and_skips_subagents() {
        ...
        std::fs::write(
            ...
            r#"{"session_kind":"primary","generated_title":"Parent work","info":{"cwd":"/Users/mac/Projects/Cinyuverse"}}"#,
        )
        .unwrap();
        std::fs::write(
        ...
        assert_eq!(
            sessions[0].workspace_path,
            Some(PathBuf::from("/Users/mac/Projects/Cinyuverse"))
        );
    }
