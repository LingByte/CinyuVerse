...
//! - `CINYUVERSE_FIXTURE_AUTH_STATUS=true|false|unsupported|method-not-found|malformed|timeout`
//! - `CINYUVERSE_FIXTURE_SESSION_AUTH_REQUIRED=1`
//! - `CINYUVERSE_FIXTURE_ADDITIONAL_DIRECTORIES=advertised|absent`
//! - `CINYUVERSE_FIXTURE_MCP_HTTP=advertised|absent`
            ...
            "initialize" => {
                ...
                json!({
                    ...
                    "result": {
                        ...
                        "authMethods": [],
                        "agentInfo": {
                            "name": "cinyuverse-management-fixture",
                            "version": "1.0.0-test"
                        }
                    }
                })
