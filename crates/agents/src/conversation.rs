...
//!
//! The Rust types in this module are Cinyuverse-authored for the event-sourced
...
pub enum ConversationEvent {
    ...
    /// Agent-owned ACP session metadata. This must not mutate the Cinyuverse
...
mod event_sourced_tests {
    ...
    fn conversation_event_round_trips_coverage_cases() {
        let events = vec![
            ConversationEvent::UserTurnCreated {
                ...
                workflow_refs: vec![ConversationWorkflowRef {
                    plugin_id: "cinyuverse.office".to_string(),
    ...
    fn legacy_action_id_deserializes_as_workflow_ref() {
        ...
        assert_eq!(payload.workflow_refs[0].plugin_id, "cinyuverse.office");
