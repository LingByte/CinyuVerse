...
/// processes without adding any Cinyuverse-private directory.
...
/// Re-read PATH after Cinyuverse itself has installed or updated a tool. Unlike
...
mod tests {
    ...
    mod unix_resolution {
        ...
        #[test]
        fn resolves_cinyuverse_stable_user_command_without_a_login_shell() {
            let home = tempfile::tempdir().unwrap();
