...
impl ProjectionFold {
    ...
    fn apply(
            ...
            ParsedEvent::Unknown { kind, .. } => {
                ...
                let notice = if record.event_version > CURRENT_EVENT_VERSION {
                    ConversationSessionNotice {
                        ...
                        message: Some(
                            "当前版本暂时无法显示其中一条记录，其余会话内容不受影响。更新 Cinyuverse 后可再次查看。"
                                .into(),
                        ),
                    ...
                    ConversationSessionNotice {
                        ...
                        message: Some(
                            "Cinyuverse 无法读取其中一条历史记录，其余会话内容不受影响。".into(),
                        ),
                        severity: "warning".into(),
                        ..Default::default()
                    }
        ...
        match event {
            ...
            // intentionally not folded into Cinyuverse conversation identity/title.
...
mod tests {
    ...
    async fn unknown_event_renders_placeholder_row_and_timeline_still_loads() {
        ...
        assert_eq!(
            ...
            Some("Cinyuverse 无法读取其中一条历史记录，其余会话内容不受影响。")
        );
    ...
    fn newer_event_version_renders_upgrade_guidance() {
        ...
        assert!(
            notice
                ...
                .is_some_and(|message| message.contains("更新 Cinyuverse"))
        );
    }
