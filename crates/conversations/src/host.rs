...
mod working_dir_tests {
    ...
    fn managed_worktree_cwd_joins_the_repo_folder_to_the_container() {
        let workspace = sample_workspace(true, Some("Cinyuverse"));
        let repo = sample_repo("Cinyuverse", "/Users/mac/Projects/Cinyuverse");
        let container = "/Users/mac/.cinyuverse-workspaces/workflow-debug";
        ...
        let expected = format!("{container}/Cinyuverse");
        assert_eq!(
    ...
    fn worktree_additional_directories_include_the_primary_checkout() {
        ...
        let repo = sample_repo("Cinyuverse", "/Users/mac/Projects/Cinyuverse");
        let container = "/Users/mac/.cinyuverse-workspaces/workflow-debug";
        let cwd = format!("{container}/Cinyuverse");
        ...
        assert_eq!(
            directories,
            vec![std::path::PathBuf::from("/Users/mac/Projects/Cinyuverse")]
        );
    }
}
