...
//! `~/.hermes/config.yaml`, …). Cinyuverse does not keep a separate registry.
//!
...
static MARKETPLACE_HTTP_CLIENT: LazyLock<Result<reqwest::Client, String>> = LazyLock::new(|| {
    reqwest::Client::builder()
        ...
        .user_agent("cinyuverse-mcp-market/1.0")
        .build()
