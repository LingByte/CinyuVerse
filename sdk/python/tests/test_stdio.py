...
from cinyuverse_plugin import PluginSdkError, define_plugin_worker
...
class StdioProtocolTests(unittest.IsolatedAsyncioTestCase):
        ...
        await session.handle_message(
            {
                ...
                "params": {
                    "protocolRange": ["1.1"],
                    "hostVersion": "0.1.3",
                    "pluginIdentity": {"publisher": "cinyuverse", "id": "echo"},
    ...
    async def test_isolated_exports_worker_not_fs_helpers(self) -> None:
        import cinyuverse_plugin.isolated as isolated
