...
from cinyuverse_plugin.stdio import PluginWorkerSession
from cinyuverse_plugin.worker import PluginWorkerDefinition, define_plugin_worker
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Replay Cinyuverse plugin protocol fixtures")
    parser.add_argument(
        "directory",
        nargs="?",
        type=Path,
