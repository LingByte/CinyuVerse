package dev.cinyuverse.companion

import dev.cinyuverse.remote.v1.DeviceCredential
import dev.cinyuverse.remote.v1.RedeemPairingRequest
import dev.cinyuverse.remote.v1.ServerCapabilities
...
class PairingClient(
    ...
    companion object {
        ...
        const val PROTOCOL_HEADER = "x-cinyuverse-protocol-version"
    }
}
