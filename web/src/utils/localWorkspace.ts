import type { FileEntry as LocalFileEntry } from '../../electron/types'
import type { WorkspaceDetail, VolumeDetail } from '@/types/workspace'

export type { LocalFileEntry }

/** 将 Electron 扫描结果转为 IDE 文件树结构（不经过后端） */
