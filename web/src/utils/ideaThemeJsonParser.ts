import type { ThemeCategory } from '@/config/themePresets'
import { normalizeThemeColorKeys } from '@/config/themePresets'
import { IDEA_UI_COLOR_MAP_EXTENDED } from '@/config/ideaThemeKeyMapExtended'
