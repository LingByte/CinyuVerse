import type { EditorSchemeColors, SchemeCategory } from '@/features/theme/config/editorSchemes'
import { mergeSchemeColors } from '@/features/theme/config/editorSchemes'
import {
  ICLS_ATTRIBUTE_KEY_MAP,
  ICLS_COLOR_KEY_MAP,
  ICLS_FIELD_PRIORITY,
} from '@/features/theme/config/iclsKeyMap'
