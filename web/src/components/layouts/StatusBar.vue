...
<template>
  <div class="status-bar">
    <div class="status-left">
      ...
      <span v-if="gitBranch" class="status-item git-branch">{{ gitBranch }}</span>
    ...
    <div class="status-right">
      ...
      <button class="status-btn" title="终端 (Ctrl+`)" @click="emit('toggleTerminal')"><Terminal :size="12" /></button>
