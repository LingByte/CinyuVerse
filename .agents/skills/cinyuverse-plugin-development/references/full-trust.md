...
Cinyuverse v4 treats installation and enablement as the user's decision to trust the complete package. Worker, App, Runtime, filesystem, process, and network behavior do not require per-capability grants.
