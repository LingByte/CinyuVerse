...
| ------------------------------ | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Mention boundary and selection | The composer had no Agent Mention provider or `&` typeahead option.                          | A catalog-backed selection inserts `[&Name](cinyuverse://agent/<kind>)`.                                                                                    |
...
backed by a fake MCP-capable `BackendTransport`; native cinyuverse-mcp/Broker,
...
- `cargo test -p cinyuverse-mcp`: 12 passed.
