...
configuration options. Cinyuverse creates that Session as soon as the create form
...
- When non-empty `configOptions` are advertised, Cinyuverse ignores legacy modes as
...
- Cinyuverse advertises stable boolean config-option support in the ACP client
