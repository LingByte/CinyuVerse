...
| `agent_session_default`            | global new-session ACP option ids/values only                                                 | Cinyuverse preference       |
...
Interactive authentication is a separate explicit action. Cinyuverse may launch a
...
grouped content surfaces. Use Cinyuverse tokens, standard controls, focus-visible
