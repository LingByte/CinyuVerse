...
- [x] Scan the Cinyuverse settings architecture and existing service boundaries.
- [x] Implement feature slices below after spec approval.

## T0. Worktree Setup

- [x] Remove `C:\Users\Administrator\Documents\Projects\Cinyuverse-tahoe-design-system-convergence`.
- [x] Create `C:\Users\Administrator\Documents\Projects\Cinyuverse-settings-platform-services`.
...
- [x] Task: Port backup core and commands.
  - Acceptance: create, inspect, stage restore, and progress event commands exist and target Cinyuverse data paths.
...
- [x] Task: Wire Cinyuverse events into channel notifications.
