...
- OfficeCLI is installed under Cinyuverse's managed tool root from a version-locked
...
- The bundled `cinyuverse.office` manifest and all three Cinyuverse-authored Skill
