# Cinyuverse Desktop Branding Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** 灏嗘闈㈢鍝佺墝鏇存柊涓?`Cinyuverse`锛屼繚鐣?Tauri + frontend 鏋舵瀯锛屽苟绉婚櫎鐙珛 Web/PWA 鍝佺墝鍏ュ彛銆?
...
**Files:**
- Create: `frontend/src/assets/cinyuverse.png`
...
灏?`C:/Users/Administrator/Downloads/Cinyuverse.png` 澶嶅埗鍒?`frontend/src/assets/cinyuverse.png`銆?

**Step 2: Implement minimal branding updates**

- `Logo.tsx` 鏀逛负鍥剧墖 + `Cinyuverse`
- `SettingsLayout.tsx` 鍦ㄩ〉澶村睍绀哄唴閮ㄥ搧鐗屽浘
- 缁熶竴鍏抽敭鐢ㄦ埛鍙鏂囨涓?`Cinyuverse`
- `ProjectContext.tsx` 椤甸潰鏍囬鏀逛负 `Cinyuverse`
- `CreatePRDialog.tsx` 榛樿 PR 鏍囬鍚庣紑鏀逛负 `(Cinyuverse)`
...
- `productName` 鏀逛负 `Cinyuverse`
- `app.windows[0].title` 鏀逛负 `Cinyuverse`

**Step 2: Generate icon set**

浠?`C:/Users/Administrator/Downloads/Cinyuverse_background.png` 鐢熸垚 `src-tauri/icons/` 闇€瑕佺殑鏍囧噯鍥炬爣鏂囦欢銆?
