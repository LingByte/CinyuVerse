# Cinyuverse Desktop Branding Design

## Goal

灏嗗綋鍓嶉」鐩殑妗岄潰绔搧鐗岀粺涓€涓?`Cinyuverse`锛屽苟淇濈暀 `frontend/` 浣滀负 Tauri 鍐呭祵鐣岄潰銆傜Щ闄ょ嫭绔?Web/PWA 鏆撮湶闈紝浣嗕笉鐮村潖妗岄潰绔瀯寤洪摼璺€?

## Scope

### In scope

- 灏嗘闈㈢鐢ㄦ埛鍙鍝佺墝鍚嶆洿鏂颁负 `Cinyuverse`
- 灏?`src-tauri/tauri.conf.json` 涓殑 `productName` 涓庣獥鍙ｆ爣棰樻洿鏂颁负 `Cinyuverse`
- 浣跨敤 `C:/Users/Administrator/Downloads/Cinyuverse_background.png` 鐢熸垚妗岄潰搴旂敤鍥炬爣
- 浣跨敤 `C:/Users/Administrator/Downloads/Cinyuverse.png` 浣滀负搴旂敤鍐呴儴鍝佺墝鍥?
- 鍦ㄨ缃〉澧炲姞鍐呴儴鍝佺墝灞曠ず
