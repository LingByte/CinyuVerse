...
Run: `cargo test build_empty_project_usage_statistics_returns_zeroed_result --package cinyuverse`
...
Run: `cargo test merge_provider_sessions_combines_multiple_workspaces --package cinyuverse`
...
Run: `cargo test project_usage --package cinyuverse`
