...
headless `cinyuverse-server`, Web/Remote Desktop transports, device pairing, and
...
3. Deploy the desktop and `cinyuverse-server` binaries plus matching Web static tree.
