...
Why it matters:
Cinyuverse is state-heavy. Color should help users distinguish selected session, active workspace, running process, warnings, failures, and review state. Decorative color competes with that job.
