...
const DISMISSED_NOTICE_KEY_PREFIX = 'cinyuverse:dismissed-conversation-notice';
const DISMISSED_SIGNATURES_KEY =
  'cinyuverse:dismissed-conversation-notice-signatures';
const SEEN_ANNOUNCEMENTS_KEY = 'cinyuverse:seen-session-announcements';
const DISMISSED_ANNOUNCEMENTS_KEY = 'cinyuverse:dismissed-session-announcements';
