...
describe('DevicePairingPanel', () => {
  ...
  it('creates a short-lived pairing challenge without placing the secret in a URL', async () => {
    ...
    qrPayloads.length = 0;
    const invitation =
      'cinyuverse-pairing:{"host_id":"host-1","preset":"companion","pairing_token":"pair-once-secret","reachability":[{"origin":"http://192.168.1.20:17891","kind":"lan"}]}';
  ...
  it('expands every connection address with a copy control', async () => {
    ...
    const createDevicePairing = vi.fn(async () => ({
      ...
      invitation: 'cinyuverse-pairing:{"pairing_token":"K7M2NPQX"}',
      reachability: [
