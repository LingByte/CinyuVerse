...
export const PLUGIN_DEVELOPMENT_PLUGIN_ID = 'cinyuverse.plugin-development';
export const PLUGIN_DEVELOPMENT_DOCS_URL =
  'https://cinyuverse.xforver.xin/docs/developers';

export const OFFICIAL_PLUGIN_I18N_KEY = {
  'cinyuverse.office': 'office',
  'cinyuverse.workflow-creator': 'workflowCreator',
  'cinyuverse.session-enhance': 'sessionEnhance',
  'cinyuverse.multi-agent': 'multiAgent',
  'cinyuverse.plugin-development': 'pluginDevelopment',
} as const;
