...
const APP_SURFACE_PROTOCOL = 'cinyuverse.app-surface/1';
...
export function buildAppSurfaceDocument({
  ...
  const boot = `(() => {
    ...
    Object.defineProperty(globalThis, 'cinyuverseSurface', {
      configurable: false,
      enumerable: true,
      writable: false,
    ...
    const applyContext = (context) => {
      ...
      dispatchEvent(new CustomEvent('cinyuversesurfacecontext', { detail: context }));
    };
        ...
        respond(port, mounted.token, requestId, {
          ...
          error: {
            ...
            message: revisionConflict
              ...
              : 'The Cinyuverse Host could not complete this request',
          },
        });
      } finally {
        pendingRequestIdsRef.current.delete(requestId);
