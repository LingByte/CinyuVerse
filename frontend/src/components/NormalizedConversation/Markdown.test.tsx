...
describe('Markdown', () => {
  ...
  it('preserves POSIX absolute file hrefs without joining the workspace twice', () => {
    renderMarkdown(
      '[events.rs](/Users/mac/Projects/Cinyuverse/src-tauri/src/events.rs)',
      { workspacePath: '/Users/mac/Projects/Cinyuverse' }
    );

    fireEvent.click(screen.getByRole('link', { name: 'events.rs' }));

    expect(panelActionsMock.openFilePreview).toHaveBeenCalledWith(
      '/Users/mac/Projects/Cinyuverse/src-tauri/src/events.rs',
      {
