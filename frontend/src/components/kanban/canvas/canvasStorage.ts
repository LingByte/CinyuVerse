...
const DOCUMENT_KEY_PREFIX = 'cinyuverse:kanban-canvas:';
export const CANVAS_BUNDLE_KEY = 'cinyuverse:kanban-canvas' as const;
const MINIMAP_KEY = 'cinyuverse:kanban-canvas-minimap';
