...
const page: LocalHistoryScanPage = {
  folders: [
    ...
    {
      path: '/Users/mac/Projects/Cinyuverse/.worktrees/feature',
      name: 'feature',
      project_id: 'project-1',
      project_name: 'Cinyuverse',
      ...
      sessions: [
        {
          ...
          workspace_path: '/Users/mac/Projects/Cinyuverse/.worktrees/feature',
          message_count: 2,
          updated_at: null,
          status: 'new',
        },
    ...
    {
      path: '/Users/mac/Projects/Cinyuverse',
      name: 'Cinyuverse',
      project_id: 'project-1',
      project_name: 'Cinyuverse',
...
describe('ImportLocalSessionsDialog', () => {
  ...
  it('puts the current project and its worktrees above other folders', async () => {
    ...
    await screen.findByRole('checkbox', { name: 'Cinyuverse' });
    ...
    expect(folders).toEqual(['Cinyuverse', 'feature', 'Other']);
  });
  ...
  it('can show every folder when the scan scope is global', async () => {
    ...
    expect(folders).toEqual(['Cinyuverse', 'feature', 'Other', 'scratch']);
  });
